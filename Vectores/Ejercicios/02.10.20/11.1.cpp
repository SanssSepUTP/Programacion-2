/* Crea un vector de 10 elementos, lo llena y almacena el factorial de sus elementos en otro vector.
 * @Author: Santiago Sepúlveda
 * @Date:   2020-10-03 12:52:15
 * @Last Modified by:   Santiago Sepúlveda
 * @Last Modified time: 2020-10-03 14:05:36
 */
#include <iostream>
using namespace std;
...
//Asigna los factoriales de un vector de n tamaño a otro del mismo tamaño.
